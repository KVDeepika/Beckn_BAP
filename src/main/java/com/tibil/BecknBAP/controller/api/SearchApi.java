...
public interface SearchApi {
    ...
    @Operation(summary = "", description = "This allows a user to search for a) Jobs and Internships b) Trainings and Courses c)", security = {
        @SecurityRequirement(name = "GatewaySubscriberAuth"),
@SecurityRequirement(name = "GatewaySubscriberAuthNew"),
@SecurityRequirement(name = "SubscriberAuth")    }, tags={"Frontend Request" })
    @ApiResponses(value = { 
